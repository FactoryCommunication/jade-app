        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex flex-col items-center gap-2 shrink-0">
              ...
              <Button type="button" variant="outline" size="sm" className="gap-1 text-xs h-7 w-20" onClick={() => fotoInputRef.current?.click()} disabled={uploadingFoto}>
          ...
          {/* Email e Telefoni affiancati */}
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label className="text-xs">Email</Label>
                <Button type="button" variant="outline" size="sm" onClick={addEmail} className="gap-1 h-6 text-xs px-2">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button type="button" variant="outline" size="sm" onClick={addTelefono} className="gap-1 h-6 text-xs px-2">
                  <Plus className="h-3 w-3" />Aggiungi
                </Button>
              </div>
              <div className="space-y-2">
